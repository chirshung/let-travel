<template>  
  <div>
      ...
      <!-- Component of 'default layout' using page will be added here - start-->
      <nuxt/>
      <!-- Component of 'default layout' using page will be added here - End-->      
...
export default {
    components: { TheHeader, TheFooter, TheLoading },
